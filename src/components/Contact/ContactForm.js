  ...
  useEffect(() => {
    axios({
      ...
      data: {
        ...
        username: process.env.USERNAME, // provide a user credential with subscriber role, this user does not have any priviledges so exposing this is fine at the moment
